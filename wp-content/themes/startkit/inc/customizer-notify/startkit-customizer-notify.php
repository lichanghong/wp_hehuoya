...
class Startkit_Customizer_Notify {
	...
	public function setup_actions() {
		...
		add_action( 'wp_ajax_quality_customizer_notify_dismiss_action', array( $this, 'startkit_customizer_notify_dismiss_recommended_action_callback' ) );

		add_action( 'wp_ajax_ti_customizer_notify_dismiss_recommended_plugins', array( $this, 'startkit_customizer_notify_dismiss_recommended_plugins_callback' ) );

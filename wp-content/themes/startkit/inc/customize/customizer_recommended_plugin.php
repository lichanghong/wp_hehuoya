...
$config_customizer = array(
	...
	'deactivate_button_label'   => esc_html__( 'Deactivate', 'startkit' ),
);
Startkit_Customizer_Notify::init( apply_filters( 'startkit_customizer_notify_array', $config_customizer ) );
?>
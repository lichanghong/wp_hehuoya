 ...
 */
function startkit_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function startkit_sanitize_css( $css ) {
 ...
 */
function startkit_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function startkit_sanitize_email( $email, $setting ) {
 ...
 */
function startkit_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function startkit_sanitize_html( $html ) {
 ...
 */
function startkit_sanitize_image( $image, $setting ) {
 ...
 */
function startkit_sanitize_nohtml( $nohtml ) {
 ...
 */
function startkit_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function startkit_sanitize_number_range( $number, $setting ) {
 ...
 */
function startkit_sanitize_select( $input, $setting ) {
 ...
 */
function startkit_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function startkit_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function startkit_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
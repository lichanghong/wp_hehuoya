...
// Plugin install
require get_template_directory() . '/inc/custom-controls/install_plugin/startkit_plugin_helper.php';
...
require( get_template_directory() . '/inc/customize/startkit-navigation.php');

<nav role="navigation" class="menu" id="menu-footer">
  ...
  <div style="text-align: center;"><a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=41148102000200" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img src="http://www.beian.gov.cn/file/ghs.png" style="float:left;"> 京ICP备19040792号 豫公网安备 41148102000200号</a></div> </div>
</nav><!-- #menu-primary -->
